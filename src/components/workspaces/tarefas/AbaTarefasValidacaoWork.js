...
import { addUserToTarefa, deleteTarefa, getTarefaById, getTarefas, getTarefasValidacaoWorkspace } from '../../../service/tarefa';
...
const AbaTarefasValidacaoWork = ({ _id, workspaceUsuarios }) => {
  ...
  const buscarTarefasWorkspace = () => {
    getTarefasValidacaoWorkspace(_id).then((res) => {
      setTarefas(res.data);
    }).catch(error => {
...
export default AbaTarefasValidacaoWork;
