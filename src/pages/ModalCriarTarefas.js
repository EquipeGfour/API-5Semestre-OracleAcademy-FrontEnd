...
import DropdownObjetivos from './DropDownObjetivos';

const verdeEscuro = "#346c68";

const ModalCriarTarefas = ({ onIconPress }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Modal isVisible={isModalVisible}>
                ...
                <TextInput style = {styles.modalText} multiline={true} placeholder='Data Conclusão'/>

                <DropdownObjetivos style = {styles.modalText}/>
                <DropdownComponent style = {styles.modalText}/>
                <View style={{flexDirection:'row', justifyContent:'space-between'}}>             
                    <Button title="Criar" onPress={closeModal} color = {verdeEscuro}/>
                    <View style={{ width: '10%' }} />
